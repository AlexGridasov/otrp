...
import com.gri.alex.restaurant.common.RestaurantNotFoundException;
...
public class InMemRestaurantRepository implements RestaurantRepository<Restaurant, String> {
    ...
    static {
        entities = new ConcurrentHashMap<>(Map.ofEntries(
                new SimpleEntry<>("1",
                        new Restaurant("Le Meurice", "1", "228 rue de Rivoli, 75001, Paris",
                                new ArrayList<>())),
                new SimpleEntry<>("2",
                        new Restaurant("L'Ambroisie", "2", "9 place des Vosges, 75004, Paris",
                                new ArrayList<>())),
                new SimpleEntry<>("3",
                        new Restaurant("Arpège", "3", "84, rue de Varenne, 75007, Paris",
                                new ArrayList<>())),
                new SimpleEntry<>("4",
                        new Restaurant("Alain Ducasse au Plaza Athénée", "4","25 avenue de Montaigne, 75008, Paris",
                                new ArrayList<>())),
                new SimpleEntry<>("5",
                ...
                new SimpleEntry<>("6",
                        new Restaurant("Pierre Gagnaire", "6", "6, rue Balzac, 75008, Paris",
                                new ArrayList<>())),
                new SimpleEntry<>("7",
                        new Restaurant("L'Astrance", "7", "4, rue Beethoven, 75016, Paris",
                                new ArrayList<>())),
                new SimpleEntry<>("8",
                        new Restaurant("Pré Catelan", "8", "Bois de Boulogne, 75016, Paris",
                                new ArrayList<>())),
                new SimpleEntry<>("9",
                        new Restaurant("Guy Savoy", "9", "18 rue Troyon, 75017, Paris",
                                new ArrayList<>())),
                new SimpleEntry<>("10", new Restaurant("Le Bristol", "10",
                        "112, rue du Faubourg St Honoré, 8th arrondissement, Paris", new ArrayList<>()))));
    }
