package com.gri.alex.api.service.restaurant;
...
public class RestaurantServiceAPI {
    ...
    public ResponseEntity<Collection<Restaurant>> findByName(@RequestParam("name") String name) {
        ...
        LOG.info("api-service findByName() invoked:{} for {} ", "v1/restaurants?name=", name);
        ...
        return new ResponseEntity<Collection<Restaurant>>(result.getBody(), HttpStatus.OK);
    }
